...
def run_stitch(input_dir, output_tiff_path, original_shape, tile_shape):
    os.system(f"python stitch_save.py {input_dir} {output_tiff_path} --original_shape {original_shape[0]} {original_shape[1]} {original_shape[2]} --tile_shape {original_shape[0]} {tile_shape[0]} {tile_shape[1]}")
