...
def parse_args():
    ...
    parser.add_argument('-seg-thr', type=float, dest='seg_thr', metavar='seg_thr', default=0.1,
    ...
    parser.add_argument('-min-size', type=int, dest='min_size', metavar='min_size', default=70,
